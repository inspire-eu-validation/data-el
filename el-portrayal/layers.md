...
* Verify for each layer that title of the layer is the one specified in the column "Layer title" in sub-clamse 11.1 or one of the translations in section 8.8 in Annex II of the regulation ([IP IOP](./README.md#ref_IR_IOP), [IP IOP Amd 2](./README.md#ref_IR_IOP_ELd2)). 
...
* [TG DS-EL](./README.md#ref_TG_DS_EL), IR Requirement, Article 14
* [TG DS-EL](./README.md#ref_TG_DS_EL), TG Requirement 7
